...
Build {
	...
	Units = function ()
		...
		local xgenerics_library = StaticLibrary {
			...
			Includes = { "../xbase/source/main/include","../xgenerics/source/main/include","../xunittest/source/main/include" },
		}
		...
		local unittest = Program {
			...
			Depends = { xbase_library,xgenerics_library,xunittest_library },
		}
		Default(unittest)
	end,
	Configs = {
